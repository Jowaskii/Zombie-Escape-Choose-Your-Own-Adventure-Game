...
Dictionary <string, string> characters = new Dictionary<string, string>() { { "MC", @"
                 ,#####,
                 #_   _#
                 |a` `a|
                 |  u  |
...
Dictionary<string, string> scenes = new Dictionary<string, string>() { { "Bedroom", @"
~.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.<>.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.~.:.~
o(=(=(=(=)=)=)=)o
 !!!!!!}!{!!!!!!                                                ___ 
 !!!!!} | {!!!!!                                               /   \
...
PrintTitleScreen();
Console.Clear();
Console.WriteLine(scenes["Bedroom"]);
...
//Openning choice
Console.WriteLine(characters["MC"]);
